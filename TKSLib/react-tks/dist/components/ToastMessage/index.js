...
const ToastMessage = (_a) => {
    ...
    return _jsx("div", Object.assign({ className: "TKS-ToastMessage", ref: toastMessageElement }, props, { id: id.current, children: _jsx("div", { className: 'TKS-ToastMessage-Container', ref: toastMessageContainerElement }) }));
};
