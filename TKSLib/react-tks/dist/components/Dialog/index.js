...
const Dialog = (_a) => {
    ...
    return _jsxs("div", Object.assign({ className: "TKS-Dialog" }, props, { ref: dialogElement, id: id.current, children: [_jsx("div", { children: _jsx(DeleteCircle, { deleteCircle: { size: 22 }, onClick: (e) => handleDelete(e) }) }), _jsxs("div", { children: [_jsx("div", { children: (_t = dialog === null || dialog === void 0 ? void 0 : dialog.data) === null || _t === void 0 ? void 0 : _t.message }), messageType.current === DIALOG_CONST.MESSAGE_TYPE.SUCCESS && _jsx("div", { children: _jsx(TickSymbol, {}) }), messageType.current === DIALOG_CONST.MESSAGE_TYPE.WARN && _jsx("div", { children: _jsx(WarnTriangle, {}) }), messageType.current === DIALOG_CONST.MESSAGE_TYPE.ERROR && _jsx("div", { children: _jsx(ErrorCircle, {}) })] }), _jsxs("div", { children: [activate_button_1.current && _jsx("button", { className: 'TKS-Dialog-botton1', onClick: (e) => handleButton1Click(e), children: button_1_name.current }), activate_button_2.current && _jsx("button", { className: 'TKS-Dialog-botton2', onClick: (e) => handleButton2Click(e), children: button_2_name.current }), activate_button_3.current && _jsx("button", { className: 'TKS-Dialog-botton3', onClick: (e) => handleButton3Click(e), children: button_3_name.current })] }), _jsx("div", { children: props.children })] }));
};
