...
const Cell = ({ data, cellIndex, rowIndex, column }) => {
    ...
    return _jsxs("div", { className: "TKS-Cell", ref: (el) => (cellElements.current[cellIndex] = el), children: [_jsx("div", { children: loadDataState === LOAD_STATE.LOADING && rowIndex !== 0 && _jsx(Loading, { load: load }) }), _jsx("div", { children: data.content }), _jsx("div", { onMouseDown: (e) => handleMouseDown(e) })] });
};
export default Cell;
