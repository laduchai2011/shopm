...
const WarnTriangle = (_a) => {
    ...
    return _jsxs("svg", Object.assign({ className: "TKS-WarnTriangle", ref: warnTriangleElement, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg" }, props, { children: [_jsx("path", { d: "M1.608,18 L12,0 L22.4,18 Z M12,3 L12,13 Z M12,15 L12,16 Z" }), props.children] }));
};
