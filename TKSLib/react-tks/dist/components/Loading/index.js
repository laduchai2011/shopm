...
const Loading = ({ load }) => {
    ...
    return _jsxs("div", { className: "TKS-Loading", children: [load.type === LOAD_COMPONENTS_CONST.LOADING_TYPE.DOT_CIRCLE && _jsx(DotCircle, { dotCircleLoad: load.infor }), load.type === LOAD_COMPONENTS_CONST.LOADING_TYPE.LINE_CIRCLE && _jsx(LineCircle, { lineCircleLoad: load.infor }), load.type === LOAD_COMPONENTS_CONST.LOADING_TYPE.SKELETON && _jsx(Skeleton, { skeletonLoad: load.infor })] });
};
