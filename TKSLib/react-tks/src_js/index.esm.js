...
var DeleteCircle = function (_a) {
    ...
    var deleteCircleElement = useRef(null);
    useEffect(function () {
...
var TickSymbol = function (_a) {
    ...
    var tickSymbolElement = useRef(null);
    useEffect(function () {
...
var WarnTriangle = function (_a) {
    ...
    var warnTriangleElement = useRef(null);
    useEffect(function () {
...
var ErrorCircle = function (_a) {
    ...
    var errorCircleElement = useRef(null);
    useEffect(function () {
...
var Dialog = function (_a) {
    ...
    var id = useRef("Dialog__T: ".concat(useId()));
    var dialogElement = useRef(null);
    var showCommand = useRef('show');
    var _u = useState(), isShow_ = _u[0], setIsShow_ = _u[1];
    var showTime = useRef(0.3);
    var messageType = useRef(undefined);
    var activate_button_1 = useRef(undefined);
    var activate_button_2 = useRef(undefined);
    var activate_button_3 = useRef(undefined);
    var button_1_name = useRef(undefined);
    var button_2_name = useRef(undefined);
    var button_3_name = useRef(undefined);
...
var Overlay = function (_a) {
    ...
    var overlayElement = useRef(null);
    var showCommand = useRef('showTop');
    var id = useRef("Dialog__T: ".concat(useId()));
    var _e = useState(), isShow_ = _e[0], setIsShow_ = _e[1];
    useEffect(function () {
        var _a, _b, _c, _d;
...
var MessageBox = function (_a) {
    ...
    var messageBoxElement = useRef(null);
    var autoRemoveShow = useRef(true);
    var color;
...
var ToastMessage = function (_a) {
    ...
    var id = useRef("ToastMessage__T: ".concat(useId()));
    var toastMessageElement = useRef(null);
    var toastMessageContainerElement = useRef(null);
    var maxMessage_ = useRef(10);
    var _c = useState([]), allData = _c[0], setAllData = _c[1];
...
export { DeleteCircle$1 as DeleteCircle, index$2 as Dialog, ErrorCircle$1 as ErrorCircle, useFollowState as FollowState, Loading$1 as Loading, handleNext as Next, index$1 as OverLay, index$3 as Table, TickSymbol$1 as TickSymbol, index as ToastMessage, WarnTriangle$1 as WarnTriangle };
