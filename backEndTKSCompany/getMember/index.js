...
app.use('/api/svGetMember', function (req, res, next) {
...
if (process.env.NODE_ENV === 'development') {
    ...
    app.use('/api/svGetMember', morgan('dev'));
}

app.use(cookieParser());
app.use('/api/svGetMember', express.json());
app.use('/api/svGetMember', express.urlencoded({extended: true}));
