...
const TickSymbol = (_a) => {
    ...
    return _jsxs("svg", Object.assign({ className: "TKS-TickSymbol", ref: tickSymbolElement, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg" }, props, { children: [_jsx("circle", { cx: '12', cy: '12', r: '12' }), _jsx("path", { d: "M7,11 L12,19 Z M12,18 L18,6 Z" }), props.children] }));
};
